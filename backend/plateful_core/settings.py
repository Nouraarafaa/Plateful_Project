"""
Django settings for plateful_core project.
...
SECRET_KEY = 'django-insecure-yq4sy=jwb_x-)kyo@fr40=mi1k96s-6oc46r)ki*kf-y3+hnct'
...
ROOT_URLCONF = 'plateful_core.urls'
...
WSGI_APPLICATION = 'plateful_core.wsgi.application'
